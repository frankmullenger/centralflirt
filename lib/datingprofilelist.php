...
class DatingprofileList extends Widget
{
    ...
    function showProfile()
    {
        ...
        $datingProfile = Dating_profile::staticGet('id', $this->profile->id);
        ...
        if ($datingProfile->location) {
            $this->out->elementStart('dl', 'entity_location');
            $this->out->element('dt', null, _('Location'));
            $this->out->elementStart('dd', 'location');
            $this->out->raw($this->highlight($datingProfile->location));
            $this->out->elementEnd('dd');
            $this->out->elementEnd('dl');
        }
        ...
        //TODO frank: need to sort out tags here
        if ($this->owner) {
            # Get tags
